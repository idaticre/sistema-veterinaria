...
const slides = [
  ...
  },
  {
    ...
    image: '/src/pages/home/images/peluqueria.png',
  ...
  },
  {
    ...
    image: '/src/pages/home/images/alimentos.png',
    ...
    <section className="crsl-header ">
      <div className="crsl-wrapper">
        <div className="crsl-slide">
          ...
          <button className="crsl-arrow crsl-next" onClick={nextSlide}>
            ⟩
          </button>
        </div>
        ...
        <div className="crsl-dots">
          {slides.map((_, idx) => (
            <span
              key={idx}
              className={idx === currentSlide ? 'crsl-dot active' : 'crsl-dot'}
