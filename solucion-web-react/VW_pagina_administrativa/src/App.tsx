...
import Horarios_colaboradores from './pages/administrativas/administracion/horarios-de-colaboradores/horariosDeColaboradores';
      ...
      <Routes>
        ...
        <Route element={<RutaProtegida />}>
          ...
          <Route element={<RutaProtegidaPorRol roles={["ADMINISTRADOR GENERAL"]} />}>
            ...
            <Route path='/administracion/administracion/horarios_de_colaboradores' element={<Horarios_colaboradores/>}/>
